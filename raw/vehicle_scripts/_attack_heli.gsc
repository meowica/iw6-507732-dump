...
preLoad()
{
	...
	attack_heli_fx();
	thread init();
	//vehicle_scripts\_mi28::main( "vehicle_mi-28_flying" );		//why is this here?
}
...
"Example: attack_heli = thread vehicle_scripts\_attack_heli::start_attack_heli();"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
...
"Example: eHeli = vehicle_scripts\_attack_heli::begin_attack_heli_behavior( eHeli );"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
...
"Example: eHeli thread vehicle_scripts\_attack_heli::turret_minigun_fire( eTarget, 10 );"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
...
can_see_player( player )
{
	...
	if ( SightTracePassed( tag_flash_loc, pos, false, undefined ) )
		return true;
	else
	{
...
littlebird_turrets_think( eHeli )
{
	...
	eTurret = self;
	eTurret maps\_vehicle_code::turret_set_default_on_mode( "manual" );
...
"Module: Vehicles"
"Example: self thread vehicle_scripts\_attack_heli::heli_default_missiles_on();"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
...
"Module: Vehicles"
"Example: self thread vehicle_scripts\_attack_heli::heli_default_missiles_off();"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
...
"OptionalArg: <genericPlayerLock>: Simply locks onto the player."
"Example: attack_heli thread vehicle_scripts\_attack_heli::heli_spotlight_on();"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
...
"Module: Vehicles"
"Example: eHeli thread vehicle_scripts\_attack_heli::heli_spotlight_off();"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
...
"Module: Vehicles"
"Example: eHeli thread vehicle_scripts\_attack_heli::heli_spotlight_random_targets_on();"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
...
"Module: Vehicles"
"Example: eHeli thread vehicle_scripts\_attack_heli::heli_spotlight_random_targets_off();"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
...
"Example: eHeli thread vehicle_scripts\_attack_heli::heli_fire_missiles( eTarget, 2, .5 );"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
