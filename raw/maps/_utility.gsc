...
delete_exploder( num )
{
	maps\_exploder::delete_exploder_proc( num );
}
...
{
	maps\_exploder::hide_exploder_models_proc( num );
}
...
{
	maps\_exploder::show_exploder_models_proc( num );
}
...
stop_exploder( num )
{
	maps\_exploder::stop_exploder_proc(num);
}
...
{
	return maps\_exploder::get_exploder_array_proc( msg );
}
...
describe_start( msg, func, loc_string, optional_func, transient )
{
    add_start_assert();
	...
	level.start_description[ msg ] = add_start_construct( msg, func, loc_string, optional_func, transient );
}
...
"OptionalArg: <transient>: Transient to load if this start point is used"
"Example: 	add_start( "first_hind", ::start_first_hind, &"STARTS_FIRSTHIND" );"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
add_start( msg, func, loc_string, optional_func, transient )
{
    add_start_assert();
	...
	if ( IsDefined( level.start_description ) && IsDefined( level.start_description[ msg ]  ) )
	{
    	...
    	array = add_start_construct( msg, func, loc_string, optional_func, transient );
...
add_start_construct( msg, func, loc_string, optional_func, transient )
{
...
//TODO: Why do these exist when they are empty??? slowmo_start / slowmo_end
...
vision_set_fog_changes( vision_set, transition_time )
{
	...
	if ( do_fog )
	{
		if ( IsDefined( get_vision_set_fog( vision_set ) ) )
...
activate_exploders_in_volume()
{
	...
	foreach ( EntFx in level.createfxent )
	{
	    ...
	    maps\_exploder::setup_individual_exploder( new_ent );
	    EntFX.model = new_ent;
	}
	test_org delete();
}
...
"Module: Utility"
"MandatoryArg: <flg> : flag to wait for before the function occurs"
"MandatoryArg: <func> : The function to run."
"OptionalArg: <arg1> : parameter 1 to pass to the process"
"OptionalArg: <arg2> : parameter 2 to pass to the process"
"OptionalArg: <arg3> : parameter 3 to pass to the process"
...
"OptionalArg: <arg5> : parameter 5 to pass to the process"
"OptionalArg: <arg6> : parameter 6 to pass to the process"
"Example: flagWaitThread( "player_can_rappel", ::flag_set, "player_can_rappel_dupe" );
"SPMP: both"
///ScriptDocEnd
=============
*/
flagWaitThread( flag, func, param1, param2, param3, param4, param5, param6 )
{
	...
	// to thread it off
	thread flagWaitThread_proc( func, flag, param1, param2, param3, param4, param5, param6 );
}
...
"Summary: flagWaitThread waits for a flag set to run a function. Note if you want an extra wait after the flag send an array -- flg = [ "flag_name", 2 ]"
"Module: Utility"
"MandatoryArg: <note> : notify to wait for before the function occurs"
"MandatoryArg: <func> : The function to run."
"OptionalArg: <arg1> : parameter 1 to pass to the process"
"OptionalArg: <arg2> : parameter 2 to pass to the process"
"OptionalArg: <arg3> : parameter 3 to pass to the process"
...
"OptionalArg: <arg5> : parameter 5 to pass to the process"
"OptionalArg: <arg6> : parameter 6 to pass to the process"
"Example: waittillThread( "player_can_rappel", ::flag_set, "flag_player_can_rappel" );
"SPMP: both"
///ScriptDocEnd
=============
*/
...
"Summary: Returns the length of a music alias."
"Module: Utility"
...
=============
///ScriptDocBegin
"Name: set_audio_zone( <name>, [fade] )"
"Summary: Starts the new audio zone, which can include ambient track, ambient events/elements, occlusion, reverb, filter, etc."
"Module: Utility"
"CallOn: "
"MandatoryArg: <name>: the name of the audio zone. From the soundtable csv"
"OptionalArg: <fade>: the crossfade time to the new zone."
"Example: set_audio_zone( "exterior_base", 10 )"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
set_audio_zone( name, fade )
{
	maps\_audio::set_zone( name, fade );
}

/*
=============
///ScriptDocBegin
"Name: stop_audio_zones( [fade] )"
"Summary: Stops all audio zones"
"Module: Utility"
"CallOn: "
"OptionalArg: [fade]: the time it takes to fade out all zones"
"Example: stop_audio_zones( 2 )"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
stop_audio_zones( fade )
{
	maps\_audio::stop_zones( fade );
}
...
///ScriptDocBegin
"Name: get_audio_zone()"
"Summary: Returns the current active zone"
"Module: Utility"
"CallOn: "
"Example: "
"SPMP: singleplayer"
...
=============
///ScriptDocBegin
"Name: set_filter( <track>, [index] )"
"Summary: Sets the audio filter"
"Module: Utility"
"CallOn: "
"MandatoryArg: <name>: the filter to use, specified in the soundtable csv"
"OptionalArg: [index]: sets which filter to apply to (0 or 1)."
"Example: "
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
set_audio_filter( name, index )
{
	maps\_audio::set_filter( name, index );
}
...
=============
///ScriptDocBegin
"Name: clear_audio_filter( [index] )"
"Summary: Clears the audio filter"
"Module: Utility"
"CallOn: "
"OptionalArg: [index]: clears the specified filter index (0 or 1)"
"Example: "
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
clear_audio_filter( index )
{
	maps\_audio::clear_filter( index );
}

/*
=============
///ScriptDocBegin
"Name: set_audio_occlusion( <name> )"
"Summary: Sets the occlusion to use"
"Module: Utility"
"CallOn: "
"MandatoryArg: <name>: the occlusion to use, specified in the soundtable csv"
"Example: "
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
set_audio_occlusion( name )
{
	maps\_audio::set_occlusion( name );
}

/*
=============
///ScriptDocBegin
"Name: clear_audio_occlusion( <name> )"
"Summary: Clears occlusion"
"Module: Utility"
"CallOn: "
"Example: "
"SPMP: singleplayer"
...
=============
///ScriptDocBegin
"Name: sound_fade_and_delete( <fade> )"
"Summary: Fades out the sound self is playing and then deletes self"
"Module: Utility"
"CallOn: entity"
"MandatoryArg: <fade>: the duration it takes to fade out the sound"
"Example: level.my_sound_org sound_fade_and_delete( 4 )"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
sound_fade_and_delete( fade )
{
	self ScaleVolume( 0, fade );
	self delayCall( fade + 0.05, ::StopSounds );
	self delayCall( fade + 0.1, ::Delete );
}

/*
=============
///ScriptDocBegin
"Name: sound_fade_in( <alias>, <volume>, <fade>, [is_loop] )"
"Summary: Fades out the sound self is playing and then deletes self"
"Module: Utility"
"CallOn: entity"
"MandatoryArg: <alias>: the soundalias to play"
"MandatoryArg: <volume>: the volume to play at after it's faded in"
"MandatoryArg: <fade>: the duration it takes to fade in the sound"
"OptionalArg: [is_loop]: if true, uses playloopsound()"
"Example: level.my_sound_org sound_fade_in( "pa_system", 1, 5 )"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
sound_fade_in( alias, volume, fade, is_loop )
{
	...
	self delaycall( 0.05, ::ScaleVolume, volume, fade );
}

/*
=============
///ScriptDocBegin
"Name: delete_on_sounddone()"
"Summary: Deletes self when "souddone" is notified"
"Module: Utility"
"CallOn: entity"
"Example: level.my_sound_org delete_on_sounddone()"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
...
=============
///ScriptDocBegin
"Name: set_level_fadein_time( <fade> )"
"Summary: Sets the time it takes for the level fadein audio to be at full volume"
"Module: Utility"
"CallOn: "
"Example: set_level_fadein_time( 5 )"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
set_level_fadein_time( fade )
{
	level._audio.level_fade_time = fade;
}
...
=============
///ScriptDocBegin
"Name: set_audio_mix( <name> )"
"Summary: Sets the mix to the name specified in the soundtable"
"Module: Utility"
"CallOn: "
"MandatoryArg: <name>: name of the mix in the soundtable"
"Example: set_audio_mix( "interior_ship" )"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
set_audio_mix( name )
{
	maps\_audio::set_mix( name );
}

/*
=============
///ScriptDocBegin
"Name: clear_audio_mix( [fade] )"
"Summary: Clears the current mix"
"Module: Utility"
"CallOn: "
"OptionalArg: [fade]: duration it takes to fade out the mix"
"Example: clear_audio_mix( 0.5 )"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
clear_audio_mix( fade )
{
	maps\_audio::clear_mix( fade );
}

/*
=============
///ScriptDocBegin
"Name: previous_audio_mix()"
"Summary: Switches to the previous audio mix"
"Module: Utility"
"CallOn: "
"Example: previous_audio_mix()"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
previous_audio_mix()
{
//	maps\_audio::change_mix( level._audio.mix.previous );
}
...
///ScriptDocBegin
"Name: in_alien_mode()"
"Summary: Return whether in alien game mode or not"
"Module: Utility"
"CallOn: "
"Example: in_alien_mode()"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
...
in_alien_mode()
{
	if ( isDefined ( level.alien_mode ) && level.alien_mode == true )
	{
		return true;
	}
	else
