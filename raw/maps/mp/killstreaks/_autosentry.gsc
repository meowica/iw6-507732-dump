...
init()
{
	...
	level.sentryType[ "scramble_turret" ] 	= "scramble_turret";
	...
	level.killStreakFuncs[ level.sentryType[ "scramble_turret" ] ]  = ::tryUseScramble;
	...
	//level.sentrySettings[ "minigun_turret" ].ownerHintString =		&"KILLSTREAKS_DOUBLE_TAP_TO_CARRY";	
	...
	//level.sentrySettings[ "gl_turret" ].ownerHintString =		&"KILLSTREAKS_DOUBLE_TAP_TO_CARRY";	
	...
	level.sentrySettings[ "scramble_turret" ] = spawnStruct();
	level.sentrySettings[ "scramble_turret" ].health =				999999; // keep it from dying anywhere in code
	level.sentrySettings[ "scramble_turret" ].maxHealth =			1000; // this is the health we'll check
	level.sentrySettings[ "scramble_turret" ].burstMin =			20;
	level.sentrySettings[ "scramble_turret" ].burstMax =			120;
	level.sentrySettings[ "scramble_turret" ].pauseMin =			0.15;
	level.sentrySettings[ "scramble_turret" ].pauseMax =			0.35;	
	level.sentrySettings[ "scramble_turret" ].sentryModeOn =		"sentry";	
	level.sentrySettings[ "scramble_turret" ].sentryModeOff =		"sentry_offline";	
	level.sentrySettings[ "scramble_turret" ].timeOut =				90.0;	
	level.sentrySettings[ "scramble_turret" ].spinupTime =			0.05;	
	level.sentrySettings[ "scramble_turret" ].overheatTime =		8.0;	
	level.sentrySettings[ "scramble_turret" ].cooldownTime =		0.1;	
	level.sentrySettings[ "scramble_turret" ].fxTime =				0.3;	
	level.sentrySettings[ "scramble_turret" ].streakName =				"sam_turret";
	level.sentrySettings[ "scramble_turret" ].weaponInfo =				"sam_mp";
	level.sentrySettings[ "scramble_turret" ].modelBase =				"mp_sam_turret";
	level.sentrySettings[ "scramble_turret" ].modelPlacement =			"mp_sam_turret_placement";
	level.sentrySettings[ "scramble_turret" ].modelPlacementFailed =	 	"mp_sam_turret_placement_failed";
	level.sentrySettings[ "scramble_turret" ].modelDestroyed =			"mp_sam_turret";	
	level.sentrySettings[ "scramble_turret" ].hintString =				&"SENTRY_PICKUP";	
	level.sentrySettings[ "scramble_turret" ].headIcon =			true;	
	level.sentrySettings[ "scramble_turret" ].teamSplash =			"used_sentry";	
	level.sentrySettings[ "scramble_turret" ].shouldSplash =		false;	
	level.sentrySettings[ "scramble_turret" ].voDestroyed =			"sam_destroyed";		

	level._effect[ "sentry_overheat_mp" ]	= loadfx( "fx/smoke/sentry_turret_overheat_smoke" );
	level._effect[ "sentry_explode_mp" ]	= loadfx( "fx/explosions/sentry_gun_explosion" );
	level._effect[ "sentry_smoke_mp" ]		= loadfx( "fx/smoke/car_damage_blacksmoke" );
}
...
tryUseScramble( lifeId )
{
	result = self giveSentry( "scramble_turret" );
	if ( result )
	{
		self maps\mp\_matchdata::logKillstreakEvent( level.sentrySettings[ "scramble_turret" ].streakName, self.origin );
	}
...
sentry_destroy_on_moving_collision()
{
	self endon( "carried" );

	self maps\mp\_movers::script_mover_generic_collision_destroy( true );
}
...
sentry_setPlaced()
{
	...
	self thread sentry_destroy_on_moving_collision();
