...
*/
	...
	player SetClientDvar( "ui_ac130_105mm_ammo", player GetWeaponAmmoClip( "ac130_105mm_mp" ) );
	player SetClientDvar( "ui_ac130_40mm_ammo", player GetWeaponAmmoClip( "ac130_40mm_mp" ) );
	player SetClientDvar( "ui_ac130_25mm_ammo", player GetWeaponAmmoClip( "ac130_25mm_mp" ) );

	player SetClientDvar( "ui_ac130", true );
	player SetClientDvar( "ui_ac130_thermal", 0 );
...
#/
	...
	self SetClientDvar( "ui_ac130_use_time", ( lifeSpan * 1000 ) + GetTime() );
	maps\mp\gametypes\_hostmigration::waitLongDurationWithHostMigrationPause( lifeSpan );
	self SetClientDvar( "ui_ac130_use_time", 0 );
...
removeAC130Player( player, disconnected )
{
	...
	if ( !disconnected )
	{
		...
		player SetClientDvar( "ui_ac130", false );
	}
...
updatePlaneModelCoords()
{
	...
	while( true )
	{
		...
		self SetClientDvar( "ui_ac130_coord1_posx", abs( level.ac130.planeModel.origin[0] ) );
		self SetClientDvar( "ui_ac130_coord1_posy", abs( level.ac130.planeModel.origin[1] ) );
		self SetClientDvar( "ui_ac130_coord1_posz", abs( level.ac130.planeModel.origin[2] ) );
...
updatePlayerPositionCoords()
{
	...
	{
		// player position
		self SetClientDvar( "ui_ac130_coord2_posx", abs( self.origin[0] ) );
		self SetClientDvar( "ui_ac130_coord2_posy", abs( self.origin[1] ) );
		self SetClientDvar( "ui_ac130_coord2_posz", abs( self.origin[2] ) );
...
updateAimingCoords()
{
	...
	while( true )
	{
		...
		// aiming position
		self SetClientDvar( "ui_ac130_coord3_posx", abs( pos[0] ) );
		self SetClientDvar( "ui_ac130_coord3_posy", abs( pos[1] ) );
		self SetClientDvar( "ui_ac130_coord3_posz", abs( pos[2] ) );
...
changeWeapons()
{
	...
	for(;;)
	{
		...
		{
		case "ac130_105mm_mp":
			self SetClientDvar( "ui_ac130_weapon", 0 );
			break;
		case "ac130_40mm_mp":
			self SetClientDvar( "ui_ac130_weapon", 1 );
			break;
		case "ac130_25mm_mp":
			self SetClientDvar( "ui_ac130_weapon", 2 );
			break;
		}
	}
}
...
weaponFiredThread()
{
	...
	for(;;)
	{
		...
		case "ac130_105mm_mp":
			...
			self SetClientDvar( "ui_ac130_105mm_ammo", self GetWeaponAmmoClip( weapon ) );
			break;
		case "ac130_40mm_mp":
			Earthquake (0.1, 0.5, level.ac130.planeModel.origin, 1000);
			self SetClientDvar( "ui_ac130_40mm_ammo", self GetWeaponAmmoClip( weapon ) );
			break;
		case "ac130_25mm_mp":
			self SetClientDvar( "ui_ac130_25mm_ammo", self GetWeaponAmmoClip( weapon ) );
			break;
		}
...
shotFired()
{
	...
	for (;;)
	{
		...
		if ( IsSubStr( tolower( weaponName ), "105" ) )
		{
			...
			self SetClientDvar( "ui_ac130_darken", 1 );
		}
