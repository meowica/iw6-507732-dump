...
init()
{
	...
	level.a10_fx[ "bullet_rain" ] = LoadFX( "fx/misc/warthog_volley_runner" );
	level.a10_fx[ "bullet_impacts" ] = LoadFX( "fx/impacts/warthog_volley_runner" );
	level.a10_fx[ "bullet_dust" ] = LoadFX( "fx/dust/wing_drop_dust" );
	level.a10_fx[ "afterburner" ] = LoadFX( "fx/fire/jet_afterburner" );
	level.a10_fx[ "contrail" ] = LoadFX( "fx/smoke/jet_contrail" );
	level.a10_fx[ "wingtip_light_green" ] = LoadFX( "fx/misc/aircraft_light_wingtip_green" );
	level.a10_fx[ "wingtip_light_red" ] = LoadFX( "fx/misc/aircraft_light_wingtip_red" );
		...
		foreach( player in level.players )
		{
			...
			if ( isdefined( playerteam ) )
			{
				if ( playerteam == self.team )
					player iprintln( &"KILLSTREAKS_WAR_AIRSTRIKE_INBOUND", self );
			}
		}
	}
...
startA10Shooting( moveTime ) // self == a10
{
	...
	velocity = Distance2D( start, end ) / ( moveTime / 0.05 );
