...
init()
{
	...
	config.hintString				= &"KILLSTREAKS_PLACEABLE_COVER_PICKUP";	
	config.placeString				= &"KILLSTREAKS_PLACEABLE_COVER_PLACE";	
	config.cannotPlaceString		= &"KILLSTREAKS_PLACEABLE_COVER_CANNOT_PLACE";	
	...
	config.deathVfx					= loadfx( "fx/fire/ballistic_vest_death" );
...
tryUsePlaceable( lifeId ) // self == player
{
