...
HintPrint( string, breakfunc, parm1, parm2, parm3, timeout, mintime )
{
	start_time = GetTime();
...
g_bob_scale_set_func( goalScale )
{
...
// This was for removing interactive TVs from Gulag.  It was only used in CoD4.
// Boon 2012-10: I've removed it because I'm using volume.interactives for other interactive items now.
...
flagWaitThread_proc(func, flag, param1, param2, param3, param4, param5, param6 )
{
	self endon( "death" );
	
	flag_wait( flag[ 0 ] );
	delayThread_proc( func, flag[ 1 ], param1, param2, param3, param4, param5, param6 );
}

waittillThread_proc(func, note, param1, param2, param3, param4, param5, param6 )
{
	self endon( "death" );
	
	self waittill( note[0] );
	delayThread_proc( func, note[1], param1, param2, param3, param4, param5, param6 );
}
