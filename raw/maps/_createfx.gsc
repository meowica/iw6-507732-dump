...
//	level.func_exploder_postload = ::exploder_after_load;
	...
	//need this to run first to init flags
	createfx_common(); 
...
createfx_only_triggers()
{
	...
	// We need transient zones for createfx
	trigger_classes[ "trigger_createart_transient" ] = maps\_trigger::trigger_createart_transient;
...
{
	if ( DistanceSquared( lastPlayerOrigin, level.player.origin ) > 64 * 64 )
	{
