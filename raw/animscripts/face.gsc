...
{
	anim.facial = [];
	anim.facial[ "pain" ] = [ %facial_pain_1 ];
	anim.facial[ "aim" ] = [ %facial_aim ];
	anim.facial[ "run" ] = [ %facial_run ];
	anim.facial[ "corner_stand_L" ] = [ %facial_corner_stand_L ];
	anim.facial[ "corner_stand_R" ] = [ %facial_corner_stand_R ];
	anim.facial[ "death" ] = [ %facial_death_1 ];
}
