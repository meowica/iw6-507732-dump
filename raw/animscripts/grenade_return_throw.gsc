...
main()
{
	...
	if ( throwDist < 600 && isLowThrowSafe() )
	{
		...
		{
			// really short range
			animArray = self lookupAnim( "grenade", "return_throw_short" );
		}
		else
		{
			// long range
			animArray = self lookupAnim( "grenade", "return_throw_long" );
		}
	}
	...
	if ( animArray.size == 0 )
	{
		...
		animArray = self lookupAnim( "grenade", "return_throw_default" );
	}
