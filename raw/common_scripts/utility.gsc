...
exploder( num )
{
	[[ level._fx.exploderFunction ]]( num );
}
...
/*
 =============
///ScriptDocBegin
"Name: ai_3d_sighting_model( <modelEnt>, <associatedEnt> )"
"Summary: Notify an AI recipient of the visual object location of entity"
"Module: Utility"
"CallOn: Bot client or agent player"
"MandatoryArg: <modelEnt> The visual cue entity."
"MandatoryArg: <associatedEnt> Entity the cue refers to."
"Example: aiEnt ai_3d_sighting_model( modelHighlight, enemy );"
"SPMP: both"
///ScriptDocEnd
 =============
 */
ai_3d_sighting_model( modelEnt, associatedEnt )
{
	assert( isAI( self ) );
		   
	if ( IsDefined( level.bot_funcs ) && IsDefined( level.bot_funcs["ai_3d_sighting_model"] ) )
		return self [[ level.bot_funcs["ai_3d_sighting_model"] ]]( modelEnt, associatedEnt );
}
